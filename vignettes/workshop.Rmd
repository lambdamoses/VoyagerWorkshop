...
# Introduction
Introduction slides are available [here](https://drive.google.com/file/d/1G4wdnLCtuRU_7I0zXJ3OwyyugPuhPH28/view?usp=sharing). The following R packages are used in this workshop, which are all on CRAN or Bioconductor. Bioconductor 3.17 is used in the workshop presented at Bioc2023.
```{r, message=FALSE}
...
```{r, echo=FALSE, out.width = "100%", fig.cap="Schematics of the Voyager project"}
...
![Intro to Visium, described in the previous paragraph](visium.png)
...
2. Compute Geary's C on the highly variable genes, and show the results.
